...
type Server_P2P struct {
	...
	GatewayPort   int64                  `protobuf:"varint,2,opt,name=gateway_port,json=gatewayPort,proto3" json:"gateway_port,omitempty"`
...
func (x *Server_P2P) GetAuthToken() string {
	if x != nil {
		return x.AuthToken
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\xca\x03\n" +
	"\x06Server\x12+\n" +
	...
	"\x03P2P\x12\x1d\n" +
	"\n" +
	"gateway_ip\x18\x01 \x01(\tR\tgatewayIp\x12!\n" +
	"\fgateway_port\x18\x02 \x01(\x03R\vgatewayPort\x12\x1d\n" +
	"\n" +
	"auth_token\x18\x03 \x01(\tR\tauthToken\"\xea\x03\n" +
	"\x04Data\x125\n" +
	...
	"\x04Ipfs\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03urlBKZIgithub.com/tntlinking-computeshare/computeshare-client/internal/conf;confb\x06proto3"
