...
func (c *computePowerClientClient) RunPythonPackage(ctx context.Context, in *RunPythonPackageClientRequest, opts ...grpc.CallOption) (*RunPythonPackageClientReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePowerClient_RunPythonPackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computePowerClientClient) CancelExecPythonPackage(ctx context.Context, in *CancelExecPythonPackageClientRequest, opts ...grpc.CallOption) (*CancelExecPythonPackageClientReply, error) {
	...
	err := c.cc.Invoke(ctx, ComputePowerClient_CancelExecPythonPackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedComputePowerClientServer must be embedded to have
...
func (UnimplementedComputePowerClientServer) testEmbeddedByValue()                            {}
...
func RegisterComputePowerClientServer(s grpc.ServiceRegistrar, srv ComputePowerClientServer) {
	// If the following call pancis, it indicates UnimplementedComputePowerClientServer was
...
var ComputePowerClient_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "client/compute/v1/compute_power_client.proto",
}
